...
\begin{figure}[htbp]
  ...
  \caption{Burst-score trajectories $\log_{10}B_{f,y}$ by family, 1996--2025. The dashed reference line marks the candidate-burst threshold $B=3$. The five named burst events are annotated with arrows pointing to the burst-year coordinate.}
